...
// TODO: Write your code here
function sumAndMultiply(a, b, c) { //eslint-disable-line  +  var add = sum(a,b)[0];
  var add = sum(a,b)[0];
  var add2 = sum(add, c)[0];
  var mult = multiply(a, b)[0];
  var mult2 = multiply(mult, c)[0];
  var mess1 = a + ' and ' + b + ' and ' + c + ' sum to ' + add2 + '.';
  var mess2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + mult2 + '.';
  return [add2, mult2, mess1, mess2];
}
...
// Write your code here
  var testArray = [2, 3, 4]; //eslint-disable-line
  function multiplyArray(arrayParm) { //eslint-disable-line
    var total = 1;
    for (var i = 0; i < arrayParm.length; i++) {
      total = multiply(total, arrayParm[i])[0];
    }
    var message = 'The numbers ' + arrayParm + ' have a product of ' + total + '.';
    return [total, message];
  }
